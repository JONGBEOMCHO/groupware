...
public class User {
	...
	//생성자
	public User(int emp_no, String emp_id, String emp_kname, String emp_ename, int emp_postcode, String emp_address,
			String emp_birthday, String emp_phonenumber, String emp_email, String dept_name, int emp_position,
			int emp_extnumber, int emp_grade) {
	...
	public String toString() {
		return "User [emp_no=" + emp_no + ", emp_id=" + emp_id + ", emp_kname=" + emp_kname + ", emp_ename=" + emp_ename
				+ ", emp_postcode=" + emp_postcode + ", emp_address=" + emp_address + ", emp_birthday=" + emp_birthday
				+ ", emp_phonenumber=" + emp_phonenumber + ", emp_email=" + emp_email + ", dept_name=" + dept_name
				+ ", emp_position=" + emp_position + ", emp_extnumber=" + emp_extnumber + ", emp_grade=" + emp_grade
				+ "]";
	}
